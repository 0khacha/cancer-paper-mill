...
def main():
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        torch.save({
            ...
            "metrics": val_res
        }, f"models/scibert_epoch_{epoch}.pt")
    ...
    checkpoint = torch.load(f"models/scibert_epoch_{best_epoch}.pt", weights_only=False)
    ...
    with open("models/scibert_finetuned_results.json", "w") as f:
        json.dump(save_results, f, indent=2, default=str)
    print("\nResults saved to models/scibert_finetuned_results.json")
    
    # Copy checkpoint to models/scibert_finetuned_best.pt
    import shutil
    shutil.copyfile(f"models/scibert_epoch_{best_epoch}.pt", "models/scibert_finetuned_best.pt")
    print("Best model copied to models/scibert_finetuned_best.pt")
